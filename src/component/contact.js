    ...
    <>
      ...
      <Box component="div" className={classes.mainContainer}>
        <Typography variant="h3" style={{ color: 'tomato' }}>
          <Typed strings={['Get In Touch']} typeSpeed={40} backSpeed={60} loop />{' '}
        </Typography>
        ...
        <Typography variant="h5" style={{ marginTop: '30px' }}>
          ...
          <a href="https://www.facebook.com/nuha.najah/" style={{ color: 'white' }}>
            {' '}
            <FacebookIcon />
          </a>
        </Typography>

        <Typography variant="body2" style={{ color: 'tan', marginTop: '5rem ', padding: '1rem' }}>
